...
<body class="easyui-layout" style="overflow-y: hidden">
    <div class="north" region="north" border="false">
        <div class="northDiv1">&nbsp;<img src="images/resources/blocks.gif" align="absmiddle"/> 权限统一平台
        </div>
        <div class="northDiv2">
    ...
    <div id="formLogin" method="post" style="width:300px;height:200px;" title="用户登录">
        <table width="100%" style="line-height:50px;border:red 1px;">
            <tr align="center">
                ...
                <td align="left"><input id="name" name="name" type="text" class="easyui-validatebox" required="true" /></td>
            </tr>
            <tr align="center">
                <td class="text">密码：</td>
